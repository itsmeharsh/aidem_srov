        ...
        <div class="card-panel">
            ...
            <div class="row">
                <form name="form_business" id="form_business" method="post" action="<?php echo base_url();?>admin/taxi/save_company" >
                    <input type="hidden" name="id" value="<?php echo $CategoryData['id'];?>" id="id" />
                    <div class="row">

                        <div class="col s12">
                            <label class="" for="Name">Name</label>
                            <input type="text" id="name" name="name" value="<?php echo $CategoryData['name'];?>" class="" maxlength="50" tab-index="2" required="true">
                        </div>
