<div class="section" id="delete_comment">
    <h2>Delete Comment
        <a class="headerlink" href="index.php#delete_comment" title="Permalink to this headline">¶</a>
        <a href="<?php echo $formpath.'delete_comment.php'?>" target="_blank" class="html_link">HTML Form</a>
    </h2>
    <p>Delete Comment</p>
    <h5>API LINK</h5>
    <div class="highlight-text">
        <div class="highlight">
            <pre><?php echo $apipath.'user/delete_comment';?></pre>
        </div>
    </div>
