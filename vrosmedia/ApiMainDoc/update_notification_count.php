...
<div class="section" id="update_notification_count">
    <h2>Update Notification count
        <a class="headerlink" href="index.php#update_notification_count" title="Permalink to this headline">¶</a>
        <a href="<?php echo $formpath.'update_notification_count.php'?>" target="_blank" class="html_link">HTML Form</a>
    </h2>
    <p>Update Notification count</p>
    <h5>API LINK</h5>
    <div class="highlight-text">
        <div class="highlight">
            <pre><?php echo $apipath.'setting/update_notification_count';?></pre>
        </div>
    </div>
    ...
    <div class="wy-table-responsive">
        ...
        <tbody valign="top">
            ...
            <tr class="row-even">
                ...
                <td>required</td>
                <td>you have to sent me min id</td>
            </tr>
