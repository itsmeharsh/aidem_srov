<div class="section" id="delete_business">
    <h2>Delete Business
        <a class="headerlink" href="index.php#delete_business" title="Permalink to this headline">¶</a>
        <a href="<?php echo $formpath.'delete_business.php'?>" target="_blank" class="html_link">HTML Form</a>
    </h2>
    <p>Delete Business</p>
    <h5>API LINK</h5>
    <div class="highlight-text">
        <div class="highlight">
            <pre><?php echo $apipath.'user/delete_business';?></pre>
        </div>
    </div>
