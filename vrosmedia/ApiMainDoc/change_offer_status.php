<div class="section" id="change_offer_status">
    <h2>Activate or Deactivate offer
        <a class="headerlink" href="index.php#change_offer_status" title="Permalink to this headline">¶</a>
        <a href="<?php echo $formpath.'change_offer_status.php'?>" target="_blank" class="html_link">HTML Form</a>
    </h2>
    <p>Activate or Deactivate offer</p>
    <h5>API LINK</h5>
    <div class="highlight-text">
        <div class="highlight">
            <pre><?php echo $apipath.'user/change_offer_status';?></pre>
        </div>
    </div>
