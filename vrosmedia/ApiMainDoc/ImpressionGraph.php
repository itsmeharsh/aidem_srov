...
<div class="section" id="ImpressionGraph">
    <h2>Impression Graph
        <a class="headerlink" href="index.php#ImpressionGraph" title="Permalink to this headline">¶</a>
        <a href="<?php echo $formpath.'ImpressionGraph.php'?>" target="_blank" class="html_link">HTML Form</a>
    </h2>
    <p>Impression Graph</p>
    <h5>API LINK</h5>
    <div class="highlight-text">
        <div class="highlight">
            <pre><?php echo $apipath.'graph/ImpressionGraph';?></pre>
        </div>
    </div>
