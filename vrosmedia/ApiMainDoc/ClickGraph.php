...
<div class="section" id="ClickGraph">
    <h2>CLick Graph
        <a class="headerlink" href="index.php#ClickGraph" title="Permalink to this headline">¶</a>
        <a href="<?php echo $formpath.'ClickGraph.php'?>" target="_blank" class="html_link">HTML Form</a>
    </h2>
    <p>Click Graph</p>
    <h5>API LINK</h5>
    <div class="highlight-text">
        <div class="highlight">
            <pre><?php echo $apipath.'graph/ClickGraph';?></pre>
        </div>
    </div>
