<div class="section" id="get_event_attendee">
    <h2>Get Event Attendee
        <a class="headerlink" href="index.php#get_event_attendee" title="Permalink to this headline">¶</a>
        <a href="<?php echo $formpath.'get_event_attendee.php'?>" target="_blank" class="html_link">HTML Form</a>
    </h2>
    <p>Get Event Attendee</p>
    <h5>API LINK</h5>
    <div class="highlight-text">
        <div class="highlight">
            <pre><?php echo $apipath.'business/get_event_attendee';?></pre>
        </div>
    </div>
