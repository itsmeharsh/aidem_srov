...
<div class="section" id="my_offers">
    <h2>My Offers
        <a class="headerlink" href="index.php#my_offers" title="Permalink to this headline">¶</a>
        <a href="<?php echo $formpath.'my_offers.php'?>" target="_blank" class="html_link">HTML Form</a>
    </h2>
    <p>My Offers</p>
    <h5>API LINK</h5>
    <div class="highlight-text">
        <div class="highlight">
            <pre><?php echo $apipath.'user/my_offers';?></pre>
        </div>
    </div>
