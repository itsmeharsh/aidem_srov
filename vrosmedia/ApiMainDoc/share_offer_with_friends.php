<div class="section" id="share_offer_with_friends">
    <h2>Offer Share With Friends
        <a class="headerlink" href="index.php#share_offer_with_friends" title="Permalink to this headline">¶</a>
        <a href="<?php echo $formpath.'share_offer_with_friends.php'?>" target="_blank" class="html_link">HTML Form</a>
    </h2>
    <p>Offer Share With Friends</p>
    <h5>API LINK</h5>
    <div class="highlight-text">
        <div class="highlight">
            <pre><?php echo $apipath.'business/share_offer_with_friends.php';?></pre>
        </div>
    </div>
