<div class="section" id="eventShareWithFriends">
    <h2>Event Share With Friends
        <a class="headerlink" href="index.php#eventShareWithFriends" title="Permalink to this headline">¶</a>
        <a href="<?php echo $formpath.'share_event_with_friends.php'?>" target="_blank" class="html_link">HTML Form</a>
    </h2>
    <p>Event Share With Friends</p>
    <h5>API LINK</h5>
    <div class="highlight-text">
        <div class="highlight">
            <pre><?php echo $apipath.'event/share_event_with_friends';?></pre>
        </div>
    </div>
...
<div class="highlight-js json">
 <div id="json"><div class="collapser"></div>{<span class="ellipsis"></span><ul class="obj collapsible"><li><div class="hoverable"><span class="property">code</span>: <span class="type-number">200</span>,</div></li><li><div class="hoverable"><span class="property">status</span>: <span class="type-string">"success"</span>,</div></li><li><div class="hoverable"><span class="property">message</span>: <span class="type-string">"Event Share Successfully!"</span></div></li></ul>}</div>
</div>
