<div class="section" id="add_business_revenue_count">
    <h2>Add Business Revenue count
        <a class="headerlink" href="index.php#add_business_revenue_count" title="Permalink to this headline">¶</a>
        <a href="<?php echo $formpath.'add_business_revenue_count.php'?>" target="_blank" class="html_link">HTML Form</a>
    </h2>
    <p>Get comments</p>
    <h5>API LINK</h5>
    <div class="highlight-text">
        <div class="highlight">
            <pre><?php echo $apipath.'setting/add_business_revenue_count';?></pre>
        </div>
    </div>
    ...
    <div class="wy-table-responsive">
        ...
        <tbody valign="top">
            ...
            <tr class="row-even">
                <td>type</td>
                <td>required</td>
                <td> 1=Click 2=Impression 3=QR Reader
        </td>
            </tr>
              <tr class="row-even">
                <td>business_id</td>
